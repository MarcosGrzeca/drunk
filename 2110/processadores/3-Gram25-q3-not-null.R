...
dados <- query("SELECT t.id, q3 AS resposta, textParser, textoParserEmoticom AS textoCompleto, hashtags, emoticonPos,	emoticonNeg FROM tweets t WHERE textparser <> '' AND id <> 462478714693890048 AND q2 = 1 AND q3 IS NOT NULL")
...
save(maFinal, file = "2110/rdas/3gram-25-q3-not-null.Rda")